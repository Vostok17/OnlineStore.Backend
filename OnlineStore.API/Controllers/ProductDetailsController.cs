...
namespace OnlineStore.API.Controllers
{
    ...
    public class ProductDetailsController : ControllerBase
    {
        ...
        public ProductDetailsController(IMapper mapper)
        {
            _mapper = mapper;
        ...
        [HttpGet("{id}")]
        public ActionResult<LaptopModel> GetLaptopDetails(int id)
        {
            try
            {
            ...
            {
                return NotFound(new { message = $"There is no laptop with Id = {id}." });
            }
        }
